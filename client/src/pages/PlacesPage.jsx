        ...
        <div>
          <form>
            ...
            <div className="flex">
              ...
              <button className="bg-gray-200 grow px-4 rounded-2xl mx-2">
                Add&nbsp;photo
              </button>
            </div>
            ...
            <p className="text-gray-500 text-sm">
              add checkin and checkout times , remember to have some time for
            ...
            <div className="">
              <button className="primary my-4">Saved</button>
            </div>
          </form>
        </div>
      )}
